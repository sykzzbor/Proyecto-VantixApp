...
export function ConversationThread({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      {/* Encabezado del hilo */}
      <div className="flex items-center gap-2 border-b px-3 py-2.5 md:px-4">
        <Button
          asChild
          variant="ghost"
          size="icon"
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="flex min-w-0 items-center gap-1 text-[11px] text-muted-foreground">
              ...
              {isWhatsapp && detail.customer?.phone && (
                <span className="truncate" title={detail.customer.phone}>
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          ...
                          fromCustomer && "rounded-bl-sm bg-muted",
                          !fromCustomer &&
                            failed &&
                            "rounded-br-sm border border-destructive/40 bg-destructive/5 text-foreground",
                          !failed &&
                            message.senderType === "ai" &&
                            "rounded-br-sm border bg-secondary text-secondary-foreground",
                          !failed &&
      ...
      {/* Zona de escritura */}
      {isClosed ? (
        <div className="flex items-center justify-between gap-3 border-t bg-muted/60 px-4 py-3">
        ...
        <div className="flex flex-col items-start justify-between gap-2 border-t bg-muted/60 px-4 py-3 sm:flex-row sm:items-center">
          <p className="flex items-center gap-2 text-sm text-muted-foreground">

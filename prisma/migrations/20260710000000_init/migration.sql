...
-- CreateEnum
CREATE TYPE "AgentTone" AS ENUM ('PROFESSIONAL', 'FRIENDLY', 'FORMAL', 'CASUAL');
...
CREATE TABLE "agent_settings" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "assistantName" TEXT NOT NULL DEFAULT 'Asistente',
    "tone" "AgentTone" NOT NULL DEFAULT 'PROFESSIONAL',
    "welcomeMessage" TEXT NOT NULL DEFAULT '¡Hola! ¿En qué puedo ayudarte?',
    "fallbackMessage" TEXT NOT NULL DEFAULT 'No tengo esa información. Un miembro del equipo te va a responder a la brevedad.',
    "handoffRules" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "agent_settings_organizationId_key" ON "agent_settings"("organizationId");
...
-- AddForeignKey
ALTER TABLE "agent_settings" ADD CONSTRAINT "agent_settings_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
